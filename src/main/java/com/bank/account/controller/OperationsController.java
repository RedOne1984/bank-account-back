...
import com.bank.account.dtos.Response;
...
import com.bank.account.utils.SecurityChecker;
...
public class OperationsController {
    ...
    public ResponseEntity<Object> getAllOperationForAClient(
        ...
        List<com.bank.account.entities.Operation> operations = operationService.getAllOperationByAccount(accountNumber, page, size);
